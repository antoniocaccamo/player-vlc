...
public class WWOComposite extends Composite{	

	private static Logger logger = LoggerFactory.getLogger(WWOComposite.class);
	...
	public WWOComposite(Composite parent) {
