 ...
 * {@link Composite} (or any other {@link org.eclipse.swt.widgets.Control}).
 * <p>
 * For example, here a media player component is used directly as the content pane of a
 * {@link org.eclipse.swt.widgets.Shell}, and only two lines of code that use vlcj are required:
 *
 * <pre>
 * frame = new JFrame();
...
public class SwtEmbeddedMediaPlayerComponent extends Composite implements MediaPlayerEventListener, MouseListener, MouseWheelListener, DragDetectListener, KeyListener {
	 ...
	 * Log.
	 */
	private final Logger logger = LoggerFactory.getLogger(SwtEmbeddedMediaPlayerComponent.class);
	 ...
	 */
	private final SwtMediaPlayerFactory mediaPlayerFactory;

	/**
	 * Media player.
	 */
	private final SwtEmbeddedMediaPlayer mediaPlayer;

	/**
	 * Video surface composite.
	 */
	 ...
	 */
	private final CompositeVideoSurface videoSurface;
	 ...
	 */
	public SwtEmbeddedMediaPlayerComponent(Composite parent, int style) {
		super(parent, style);
		...
		composite = onGetComposite();
		videoSurface = mediaPlayerFactory.newVideoSurface(composite);
		mediaPlayer.setVideoSurface(videoSurface);

		// Register listeners
		mediaPlayer.addMediaPlayerEventListener(this);
		EmbeddedMediaPlayerComponent.InputEvents ie = onGetInputEvents();
		logger.debug("InputEvents: {}", ie);
		switch (ie) {
			case NONE:
				break;
			case DISABLE_NATIVE:
			...
			case DEFAULT:
				...
				composite.addDragDetectListener(this);
	 ...
	 */
	public final SwtMediaPlayerFactory getMediaPlayerFactory() {
	 ...
	 * @return media player
	 */
	public final SwtEmbeddedMediaPlayer getMediaPlayer() {
		return mediaPlayer;
	}

	/**
	 * Get the video surface {@link Composite} component.
	 * <p>
	 * An application may want to add key/mouse listeners to the video surface component.
	 *
	 * @return video surface component
	 */
	public final Composite getVideoSurface() {
		return composite;
	}
	...
	protected SwtMediaPlayerFactory onGetMediaPlayerFactory() {
		...
		return new SwtMediaPlayerFactory(args);
	}
	 ...
	 * @return
	 */
	private String[] mergeArguments(String[] args, String[] extraArgs) {
		if (extraArgs != null && extraArgs.length > 0) {
			java.util.List<String> combinedArgs = new ArrayList(args.length + extraArgs.length);
	...
	/**
	 * Template method to obtain a video surface {@link Composite} component.
	 * <p>
	 * The default implementation simply returns an ordinary Composite with a black background.
	 *
	 * @return video surface component
	 */
	protected Composite onGetComposite() {
		GridLayout gridLayout = new GridLayout(1, true);
		gridLayout.marginWidth = 0;
		gridLayout.marginHeight = 0;
		GridData gridData = new GridData(SWT.FILL, SWT.FILL, true, true);
	 ...
	 */
	protected uk.co.caprica.vlcj.component.EmbeddedMediaPlayerComponent.InputEvents onGetInputEvents() {
		if (RuntimeUtil.isNix() || RuntimeUtil.isMac()) {
			return uk.co.caprica.vlcj.component.EmbeddedMediaPlayerComponent.InputEvents.DEFAULT;
		}
		else {
			return uk.co.caprica.vlcj.component.EmbeddedMediaPlayerComponent.InputEvents.DISABLE_NATIVE;
		}
	}
	...
	public void mouseDown(MouseEvent e) {
		logger.debug("SwtEmbeddedMediaPlayerComponent.mouseDown {}x{}", e.x, e.y);
	}

	@Override
	public void mouseUp(MouseEvent e) {
		logger.debug("SwtEmbeddedMediaPlayerComponent.mouseUp {}x{}", e.x, e.y);
	}

	@Override
	public void mouseDoubleClick(MouseEvent e) {
		logger.debug("SwtEmbeddedMediaPlayerComponent.mouseDoubleClick {}x{}", e.x, e.y);
	}
	...
	public void mouseScrolled(MouseEvent e) {
		logger.debug("SwtEmbeddedMediaPlayerComponent.mouseScrolled {}x{} - {}", e.x, e.y, e.count);
	}

	// === DragDetectListener ===================================================
	@Override
	public void dragDetected(DragDetectEvent e) {
		logger.debug("SwtEmbeddedMediaPlayerComponent.dragDetected {}x{} - {}", e.x, e.y, e.count);
	}

	// === KeyListener ==========================================================
	@Override
	public void keyPressed(KeyEvent e) {
		logger.debug("SwtEmbeddedMediaPlayerComponent.keyPressed {}", e.character);
	}

	@Override
	public void keyReleased(KeyEvent e) {
		logger.debug("SwtEmbeddedMediaPlayerComponent.keyReleased {}", e.character);
	}
}
